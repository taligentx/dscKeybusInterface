/*
 *  Twilio SMS Notification 1.3 (esp32)
 *
 ...
 *
 *  Release notes:
 *    1.3 - Update HTTPS root certificate for api.twilio.com: DigiCert Global Root G2
 *    1.2 - Add TLS root certificate for Twilio: DigiCert Global Root CA
