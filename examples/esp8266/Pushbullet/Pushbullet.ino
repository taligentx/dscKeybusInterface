/*
 *  Pushbullet Push Notification 1.6 (esp8266)
 *
 ...
 *
 *  Release notes:
 *    1.6 - Update HTTPS root certificate for api.pushbullet.com: ISRG Root X1
 *    1.5 - Update HTTPS root certificate for api.pushbullet.com: Google Trust Services GTS Root R1
...
// HTTPS root certificate for api.pushbullet.com: ISRG Root X1, expires 2035.06.04
