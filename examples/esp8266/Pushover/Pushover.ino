/*
 *  Pushover Push Notification 1.1 (esp8266)
 *
 ...
 *
 *  Release notes:
 *    1.1 - Update HTTPS root certificate for api.pushover.net: DigiCert Global Root G2
 *    1.0 - Initial release
 *
 *  Wiring:
...
// HTTPS root certificate for api.pushover.net: DigiCert Global Root G2, expires 2038.01.15
