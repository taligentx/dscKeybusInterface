...
void dscKeybusInterface::printPanelMessages(byte panelByte) {
  switch (panelData[panelByte]) {
    ...
    case 0xA3: stream->print(F("*4: Door chime enabled")); break;
    case 0xA4: stream->print(F("*4: Door chime disabled")); break;
    ...
    case 0xE5: stream->print(F("*8: Keypad slot assignment")); break;
    case 0xE6: stream->print(F("*8: Input 2 digits")); break;
    case 0xE7: stream->print(F("*8: Input 3 digits")); break;
    case 0xE8: stream->print(F("*8: Input 4 digits")); break;
    ...
    case 0xEC: stream->print(F("*8: Input 6 digits")); break;
    case 0xED: stream->print(F("*8: Input 32 digits")); break;
    case 0xEE: stream->print(F("*8: Input 1 option per zone")); break;
    case 0xEF: stream->print(F("*8: Module supervision field")); break;
    case 0xF0: stream->print(F("*8: Function key 1")); break;
    case 0xF1: stream->print(F("*8: Function key 2")); break;
    case 0xF2: stream->print(F("*8: Function key 3")); break;
    case 0xF3: stream->print(F("*8: Function key 4")); break;
    case 0xF4: stream->print(F("*8: Function key 5")); break;
    case 0xF5: stream->print(F("*8: Wireless module placement test")); break;
    case 0xF7: stream->print(F("*8: Installer programming subsection")); break;
    case 0xF8: stream->print(F("*8: Keypad programming")); break;
    default:
      stream->print(F("Unknown data"));
      stream->print(F(": 0x"));
